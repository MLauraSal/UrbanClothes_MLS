        ...
        <div className="showcase-wrapper has-scrollbar">
          <div className="showcase-container">
            <div className="showcase">
              <a href="#" className="showcase-img-box">
                <img
                  src="../../public/assets/img/products/clothes-1.jpg"
            ...
            <div className="showcase">
              <a href="#" className="showcase-img-box">
                <img
                  src="../../public/assets/img/products/clothes-2.jpg"
            ...
            <div className="showcase">
              <a href="#" className="showcase-img-box">
                <img
                  src="../../public/assets/img/products/clothes-3.jpg"
            ...
            <div className="showcase">
              <a href="#" className="showcase-img-box">
                <img
                  src="../../public/assets/img/products/shirt-1.jpg"
          ...
          <div className="showcase-container">
            <div className="showcase">
              <a href="#" className="showcase-img-box">
                <img
                  src="../../public/assets/img/products/jacket-5.jpg"
            ...
            <div className="showcase">
              <a href="#" className="showcase-img-box">
                <img
                  src="../../public/assets/img/products/jacket-1.jpg"
            ...
            <div className="showcase">
              <a href="#" className="showcase-img-box">
                <img
                  src="../../public/assets/img/products/jacket-3.jpg"
                  alt="mens winter leathers jackets"
                  className="showcase-img"
                  width="70"
                />
            ...
            <div className="showcase">
              <a href="#" className="showcase-img-box">
                <img
                  src="../../public/assets/img/products/shorts-1.jpg"
        ...
        <div className="showcase-wrapper has-scrollbar">
          <div className="showcase-container">
            <div className="showcase">
              <a href="#" className="showcase-img-box">
                <img
                  src="../../public/assets/img/products/sports-1.jpg"
            ...
            <div className="showcase">
              <a href="#" className="showcase-img-box">
                <img
                  src="../../public/assets/img/products/sports-2.jpg"
            ...
            <div className="showcase">
              <a href="#" className="showcase-img-box">
                <img
                  src="../../public/assets/img/products/party-wear-1.jpg"
            ...
            <div className="showcase">
              <a href="#" className="showcase-img-box">
                <img
                  src="../../public/assets/img/products/sports-3.jpg"
          ...
          <div className="showcase-container">
            <div className="showcase">
              <a href="#" className="showcase-img-box">
                <img
                  src="../../public/assets/img/products/sports-6.jpg"
            ...
            <div className="showcase">
              <a href="#" className="showcase-img-box">
                <img
                  src="../../public/assets/img/products/shoe-3.jpg"
            ...
            <div className="showcase">
              <a href="#" className="showcase-img-box">
                <img
                  src="../../public/assets/img/products/shoe-1.jpg"
            ...
            <div className="showcase">
              <a href="#" className="showcase-img-box">
                <img
                  src="../../public/assets/img/products/shoe-2.jpg"
        ...
        <div className="showcase-wrapper has-scrollbar">
          <div className="showcase-container">
            <div className="showcase">
              <a href="#" className="showcase-img-box">
                <img
                  src="../../public/assets/img/products/watch-3.jpg"
            ...
            <div className="showcase">
              <a href="#" className="showcase-img-box">
                <img
                  src="../../public/assets/img/products/jewellery-3.jpg"
            ...
            <div className="showcase">
              <a href="#" className="showcase-img-box">
                <img
                  src="../../public/assets/img/products/perfume.jpg"
            ...
            <div className="showcase">
              <a href="#" className="showcase-img-box">
                <img
                  src="../../public/assets/img/products/belt.jpg"
          ...
          <div className="showcase-container">
            <div className="showcase">
              <a href="#" className="showcase-img-box">
                <img
                  src="../../public/assets/img/products/jewellery-2.jpg"
            ...
            <div className="showcase">
              <a href="#" className="showcase-img-box">
                <img
                  src="../../public/assets/img/products/watch-1.jpg"
            ...
            <div className="showcase">
              <a href="#" className="showcase-img-box">
                <img
                  src="../../public/assets/img/products/shampoo.jpg"
            ...
            <div className="showcase">
              <a href="#" className="showcase-img-box">
                <img
                  src="../../public/assets/img/products/jewellery-1.jpg"
